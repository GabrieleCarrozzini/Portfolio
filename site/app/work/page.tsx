...
export const metadata: Metadata = {
  title: 'Selected Work',
  description:
    'Case studies and projects by Gabriele Carrozzini â€” 3D character art, poster design, advertising composition, cover design. Five projects spanning cyberpunk, film noir, and editorial aesthetics.',
};
      ...
      <div className="container-site">
        ...
        <ScrollReveal style={{ marginBottom: 'var(--space-7)' }}>
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--fs-body)', color: 'var(--gray-500)', maxWidth: '50ch', lineHeight: 1.65 }}>
            Five projects across 3D character art, poster design, advertising, and cover design â€” each built on one constraint: form over literal meaning.
          </p>
        </ScrollReveal>
        ...
        <div style={{ marginTop: 'var(--space-7)', textAlign: 'center' }}>
          <span
            className="label"
            style={{ fontFamily: 'var(--font-mono)', fontSize: '0.6rem', letterSpacing: '0.28em', color: 'rgba(250,250,248,0.2)' }}
          >
